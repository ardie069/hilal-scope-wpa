...
import type { HijriDate, MethodKey } from "@/types/hijri";
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full pt-10 border-t border-gray-100 dark:border-white/5">
            ...
            <div className="flex flex-col items-center sm:items-end gap-1">
              ...
              <div className="flex items-center gap-2">
                <span className="px-3 py-1 rounded-lg bg-gray-900 dark:bg-primary text-white dark:text-black text-[10px] font-black uppercase tracking-tighter shadow-sm">
                  {methodLabel}
                </span>
              </div>
            </div>
